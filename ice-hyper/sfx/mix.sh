...
# the kit sits far under the voice: 3 percent of the authored levels
MASTER="${MASTER:-0.03}"
...
CUES=(
  ...
  "15.70 pop.wav        0.34"
  "15.80 ticks.wav      0.22"
  "17.25 riser.wav      0.30"
  "18.60 shimmer.wav    0.26"
  "19.05 boom.wav       0.50"
...
for cue in "${CUES[@]}"; do
  ...
  vol=$(python3 -c "print(round(float('$vol')*float('$MASTER'), 5))")
  INPUTS+=(-i "$S/$file")
