  ...
  <AbsoluteFill style={{ background: theme.bg, overflow: "hidden" }}>
    <img
      ...
      style={{
        ...
        // Matches transform-origin to focus: when object-fit:cover already
        // fills one axis exactly (no crop room left, e.g. a wide photo in a
        // square frame), object-position's value on that axis is a no-op —
        // the extra `scale` above is the only thing that can still open up
        // room to pan, and only if it zooms from the same point focus names.
