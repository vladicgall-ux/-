...
/** Slide counter as a row of burn marks. */
    ...
    {Array.from({ length: total }).map((_, i) => (
      <div
        ...
        style={{
          ...
          height: 6,
          borderRadius: 3,
          background: i === active ? theme.accent : "rgba(238,243,251,0.24)",
...
export const Headline: React.FC<{
  ...
  <div
    style={{
      ...
      textTransform: "uppercase",
      textShadow:
        "0 6px 34px rgba(0,0,0,0.95), 0 2px 6px rgba(0,0,0,0.85), 0 0 60px rgba(255,143,46,0.18)",
    }}
  >
    {children}
  </div>
...
export const HotPlate: React.FC<{ children: React.ReactNode }> = ({
  ...
  <div
    style={{
      ...
      padding: "20px 28px",
      borderRadius: 4,
      background: "rgba(255,143,46,0.15)",
